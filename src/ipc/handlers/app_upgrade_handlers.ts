...
const availableUpgrades: Omit<AppUpgrade, "isNeeded">[] = [
  {
    ...
    manualUpgradeUrl: "https://codex.anishkumar.tech/docs/upgrades/select-component",
  },
  {
    id: "capacitor",
    ...
    manualUpgradeUrl: "https://codex.anishkumar.tech/docs/guides/mobile-app#upgrade-your-app",
  },
];
...
async function applyComponentTagger(appPath: string) {
  ...
  try {
    ...
    await gitCommit({
      path: appPath,
      message: "[CodeX] add CodeX component tagger",
    });
